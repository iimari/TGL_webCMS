...
<div style="visibility:hidden">
    ...
    <input type="text" name="mh_homepage" placeholder="홈페이지" value = "<?=$mo_m_data->mh_homepage?>"></input><br>
</div>
...
<th><textarea name="mh_title" cols="70" rows="2" >
<?=$mo_m_data->mh_title?></textarea></th>
